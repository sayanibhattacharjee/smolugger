...
func main() {
	...
	for {
		...
		// fmt.Println("ws.Exited ", ws.Exited())
		// fmt.Println("ws.Stopped ", ws.Stopped())
		// fmt.Println("ws.Singal ", ws.Signal())
		// fmt.Println("ws.Singalled ", ws.Signaled())
		// fmt.Println("ws.ExitStatus ", ws.ExitStatus())
